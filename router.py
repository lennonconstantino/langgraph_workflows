...
Lembre-se de sempre enfatizar que suas respostas são apenas informativas e não substituem consultas médicas.
""")
...
def router(state: State):
    """Roteia a consulta para diferente categorias baseado no conteudo."""
...
def saude(state: State):
    """Processa consultas sobre saude"""
    messages = [
